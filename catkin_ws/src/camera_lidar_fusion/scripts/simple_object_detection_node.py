...
class SimpleObjectDetectionNode:
    def __init__(self):
        rospy.init_node('simple_object_detection_node', anonymous=True)
        ...
        rospy.loginfo("Simple Object Detection Node initialized")
    ...
    def estimate_distance_from_size(self, object_area):
        ...
        distance = self.reference_distance * np.sqrt(self.reference_area / object_area)
    ...
    def image_callback(self, image_msg):
        ...
        try:
            ...
            # Add system info
            cv2.putText(debug_image, "Simple Object Detection", (10, 30), 
            ...
            if self.frame_count % 30 == 0:
                rospy.loginfo("Simple Object Detection: Processed %d frames, detected %d objects", 
...
if __name__ == '__main__':
    try:
        node = SimpleObjectDetectionNode()
        rospy.spin()
