...
# Full Enhanced Camera-LiDAR Fusion System Startup Script for Jetson Nano
# Uses manual implementations of advanced algorithms without external dependencies

echo "=========================================="
echo "Full Enhanced Camera-LiDAR Fusion System"
echo "Jetson Nano Optimized Version"
echo "Manual Algorithm Implementation"
echo "=========================================="
...
if [ -e "/dev/ttyUSB0" ]; then
    ...
    sed -i 's/\/dev\/ttyUSB0/\/dev\/ttyUSB1/g' $(find . -name "enhanced_system_full.launch")
else
...
# Launch the full enhanced system
echo "Launching Full Enhanced Camera-LiDAR Fusion System..."
echo "This system includes:"
echo "- Adaptive voxel downsampling"
echo "- RANSAC ground plane detection"
echo "- Radius-based outlier removal"
echo "- Statistical outlier removal"
echo "- Cluster-based filtering"
echo "- Temporal consistency filtering"
echo "- Intelligent ROI filtering"
echo "This may take a few moments to initialize..."

# Launch with reduced priority to prevent system overload
nice -n 10 roslaunch camera_lidar_fusion enhanced_system_full.launch

# If launch fails, try with simple enhanced system
if [ $? -ne 0 ]; then
    echo "Full enhanced system launch failed. Trying simple enhanced system..."
    echo "This will run with basic enhanced features for compatibility."
    
    # Launch simple enhanced system
